...
league_options = ['Champions League', 'Europa League', 'Top 5 Leagues', 'Ligue 1', 'Premier League', 'La Liga', 'Bundesliga', 'Serie A', 'Brazilian Serie A']
...
if selected_stats == 'Goalkeeper':
    if selected_league not in league_options[3:]:
