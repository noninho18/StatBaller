...
st.title("Player stats during the 2024-2025 season")

filepath = "./Data/2024-2025/"

league_options = ['Champions League', 'Europa League', 'Top 5 Leagues', 'Ligue 1', 'Premier League', 'La Liga', 'Bundesliga', 'Serie A', 'Belgian Pro League', 'Primeira Liga']
